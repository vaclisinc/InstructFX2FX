...
from eval.gt_bank import build_sequential_gt_bank_full
from eval.run_system import collect_final_audio_paths, run_system_for_pair
from eval.helpers import _dry_paths, _seq_gt_paths, _latest_experiment_dir

_EXP1_SYSTEM_RESULTS_DIR = os.path.join(cfg.SYSTEM_RESULTS_DIR, "exp1")
_EXP1_RESULTS_DIR = os.path.join(cfg.RESULTS_DIR, "exp1")
...
def run_exp1(
    ...
    build_sequential_gt_bank_full(cfg.WORD_PAIRS, cfg.INSTRUMENTS)
    ...
    for method, method_name in zip(methods, method_names):
        ...
        os.makedirs(_EXP1_RESULTS_DIR, exist_ok=True)
        out_path = os.path.join(_EXP1_RESULTS_DIR, f"exp1_{method_name}.json")
