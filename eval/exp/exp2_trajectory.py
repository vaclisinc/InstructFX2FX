...
from eval.exp.exp1_sequential import _compute_mmd_for_pair_instrument, _dry_paths, _latest_experiment_dir
...
def _word_gt_paths(word: str, instrument: str) -> List[str]:
    pattern = os.path.join(cfg.GT_BANK_DIR_ONESHOT, word, instrument, "*.wav")
